...
mixin GridMixin {
  ...
  late final tabletGridDelegate = Grid.videoCardHTabletDelegate(
    Pref.tabletCardScale,
  );

  SliverGridDelegate gridDelegateFor(BuildContext context) {
    if (MediaQuery.sizeOf(context).shortestSide < 600) {
      return gridDelegate;
    }
    return tabletGridDelegate;
  }

  Widget gridSkeletonFor(BuildContext context) => SliverGrid.builder(
...
abstract final class Grid {
  ...
  static SliverGridDelegateWithFixedCrossAxisCount videoCardHTabletDelegate(
    double scale,
  ) => SliverGridDelegateWithFixedCrossAxisCount(
    crossAxisCount: 3,
    mainAxisSpacing: 2,
    mainAxisExtent: 110 * scale,
  );
}
