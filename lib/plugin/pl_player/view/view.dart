      ...
      children: <Widget>[
              ...
              child: Column(
                ...
                children: [
                  AppBarAni(
                    ...
                    removeSafeArea:
                        plPlayerController.removeHorizontalFullScreenSafeArea,
        ...
        if (isFullScreen || plPlayerController.isDesktopPip) ...[
          ...
          if (plPlayerController.showFsLockBtn)
            ViewSafeArea(
              right: false,
              left: !plPlayerController.removeHorizontalFullScreenSafeArea,
              child: Align(
          ...
          if (plPlayerController.showFsScreenshotBtn)
            ViewSafeArea(
              left: false,
              right: !plPlayerController.removeHorizontalFullScreenSafeArea,
              child: Obx(
                () => Align(
