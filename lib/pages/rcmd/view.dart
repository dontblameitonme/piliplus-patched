...
class _RcmdPageState extends State<RcmdPage>
      ...
      child: refreshIndicator(
        ...
        child: LayoutBuilder(
          builder: (context, constraints) {
            final gridDelegate = _gridDelegate(constraints.maxWidth);
  ...
  Widget _buildBody(
    ...
    SliverGridDelegateWithExtentAndRatio gridDelegate,
  ) {
  ...
  Widget _buildSkeleton(SliverGridDelegateWithExtentAndRatio gridDelegate) =>
      SliverGrid.builder(
        gridDelegate: gridDelegate,
